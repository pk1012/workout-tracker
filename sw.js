const CACHE_NAME = "workout-tracker-v68";

const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./css/styles.css?v=1.7.68",
  "./css/components.css?v=1.7.68",
  "./css/responsive.css?v=1.7.68",
  "./css/progress.css?v=1.7.68",
  "./css/exercises.css?v=1.7.68",
  "./js/data.js",
  "./js/workouts.js",
  "./js/exercises.js",
  "./js/progress.js",
